 ...
 ******************************************************************************/
package xtremelabs.bbscreenshot.utilities;
...
public class Email {
	...
	public static void sendEmail(PNGEncodedImage png) {
		...
		try {
			...
			multipart.addBodyPart(new TextBodyPart(multipart, "Generic message body Generic message body Generic message body Generic message body "));
