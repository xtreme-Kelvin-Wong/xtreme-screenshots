 ...
 ******************************************************************************/
package xtremelabs.bbscreenshot.controllers;
...
import xtremelabs.bbscreenshot.BackgroundScreen;

public class TakeScreenshot  {

	private BackgroundScreen screen = new BackgroundScreen();
	
	public TakeScreenshot(){
		UiApplication.getUiApplication().pushScreen(screen);
		
		EmailPrompt.emailPrompt(makePNG());
	}
